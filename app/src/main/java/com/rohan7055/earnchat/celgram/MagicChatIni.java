...
public class MagicChatIni extends AppCompatActivity {
    RecyclerView recyclerView;
    private List<ContactsModel> contactList=new ArrayList<ContactsModel>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_magic_chat_ini);
        ...
        contactAdapter=new GetContactAdapter(this,contactList,MagicChatIni.this,0);
        for(ContactsModel contactsModel:contactList)
        {
            Log.i("chatMagic",contactsModel.getDisplay_name());
        }

        recyclerView=(RecyclerView)findViewById(R.id.create_chat_view_magic);
        RecyclerView.LayoutManager LayoutManager = new LinearLayoutManager(MagicChatIni.this);
